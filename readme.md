# NoviLabs Data Processing and Loading Pipeline
...
- **CSV Input File:**  
  - Place your input CSV file (e.g., `novi-data-engineer-assignment.csv`) in a folder named `data` in the project root.
